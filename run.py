...
def function():
	...
	print("              | |/  \| |  / __\ | |    / _ \  /  \  |  \/  |  / __\                   ")
	print("              |   /\   | |  __  | |_  | |_   | || | |  \/  | |  __                    ")
	print("              |_ /  \_ |  \__ / |___|  \___/  \__/  |_|  |_|  \___/                   ")
	print("                                 _______                                              ")
	print("                                |__   __|                                             ")
	print("                                   | |    __                                          ")
	print("                                   | |   /  \                                         ")
	...
	print("               ___                        _                                           ")
	print("              |  _ \                     | |                                          ")
	print("              | |_) )  ____  ___   ___   | |      __     __     _   _   __     _  _   ")
	print("              |  __/  / _  |/ __  / __   | |     /  \   / _ \  | |/ /  / __\  | |/ /  ")
	print("              | |    / (_| |\__ \ \__ \  | |___ | || | | |_    |   \  |  __   |  _/   ")
	print("              |_|    \_____| ___/  ___/  |_____| \__/   \___/  |_|\_\  \___/  |_|     ")
function()
    ...
    while True:
        ...
        if short_code == "cc":
            ...
            if find_credential(search_name):
                ...
                print('\n')
                print(f"Your stored credentials for : {search_credential.account} has been deleted successfully")
                print('\n')
            else:
                print("That Credential you want to delete does not exist,please enter an existing account")

        elif short_code == 'gp':

            password = generate_Password()
            print(f" {password} Has been generated succesfull. Proceed to use it to your account")
        elif short_code == 'ex':
